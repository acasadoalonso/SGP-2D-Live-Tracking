...
$(function(){
	...
	$.ajax({
		...
		success: function(json){
			socket=io.connect('http://' + json.socket.server + ':' + json.socket.port, {
			...
			socket.on('data', function (data) {
				...
				try{
					...
					var json=data
					//console.log("activeWaypoints:" + data.activeWaypoints.length)
					//console.log("aircrafts:" + data.aircrafts.length)
					//console.log("clients:" + data.clients.length)
					//console.log("stations:" + data.stations.length)
					//console.log("waypointsCount:" + data.waypointsCount.length)
			...
			if(!$.cookie("lat")||isNaN($.cookie("lat"))) $.cookie("lat", json.center.lat)
			if(!$.cookie("lon")||isNaN($.cookie("lon"))) $.cookie("lon", json.center.lon)
			if(!$.cookie("zoom")||isNaN($.cookie("zoom"))) $.cookie("zoom", json.center.zoom)
